...
4. [Erstellen Sie eine Ressourcengruppe](../articles/azure-resource-manager/resource-group-template-deploy-portal.md), oder wählen Sie eine vorhandene Ressourcengruppe aus. Geben Sie eine Azure-Region an. 
