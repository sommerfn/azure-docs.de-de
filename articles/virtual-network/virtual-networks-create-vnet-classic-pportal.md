---
title: Erstellen eines virtuellen Netzwerks (klassisch) mit dem Azure-Portal | Microsoft-Dokumentation
description: Erfahren Sie, wie Sie ein virtuelles Netzwerk (klassisch) mit dem Azure-Portal erstellen.
