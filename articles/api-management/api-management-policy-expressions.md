...
|context.Response|Hauptteil: IMessageBody<br /><br /> Headers: IReadOnlyDictionary<string, string[]><br /><br /> StatusCode: int<br /><br /> StatusReason: string|
...
|IUrl|Host: string<br /><br /> Path: string<br /><br /> Port: int<br /><br /> Abfrage: IReadOnlyDictionary<string, string[]><br /><br /> QueryString: string<br /><br /> Scheme: string|
