...
ms.locfileid: "67807053"
---
# <a name="status-monitor-v2-api-start-applicationinsightsmonitoringtrace-v040-alpha"></a>API für Statusmonitor v2: Start-ApplicationInsightsMonitoringTrace (v0.4.0-alpha)
