---
title: Leistungsüberwachung für Java-Web-Apps in Azure Application Insights (2.5.0-BETA) | Microsoft-Dokumentation
description: Erweiterte Leistungs- und Nutzungsüberwachung Ihrer Java-Website mit Application Insights (2.5.0-BETA).
...
2. Bearbeiten Sie das Startskript des Anwendungsservers, und fügen Sie die folgende JVM-arg hinzu:
...
Schlüssel: `JAVA_OPTS` Wert: `-javaagent:D:/home/site/wwwroot/applicationinsights-agent-2.5.0-BETA.jar`
