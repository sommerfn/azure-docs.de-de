...
ms.locfileid: "67807064"
---
# <a name="status-monitor-v2-api-set-applicationinsightsmonitoringconfig-v040-alpha"></a>API für Statusmonitor v2: Set-ApplicationInsightsMonitoringConfig (v0.4.0-alpha)
