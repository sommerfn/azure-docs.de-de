---
title: Untersuchen von Java-Ablaufverfolgungsprotokollen in Azure Application Insights (2.5.0-BETA) | Microsoft-Dokumentation
description: Durchsuchen von Log4J- oder Logback-Ablaufverfolgungen in Application Insights (2.5.0-BETA)
...
ms.locfileid: "68298194"
---
# <a name="explore-java-trace-logs-in-application-insights-250-beta"></a>Untersuchen von Java-Ablaufverfolgungsprotokollen in Application Insights (2.5.0-BETA)
...
## <a name="note-if-you-are-using-the-application-insights-java-agent"></a>Hinweis für die Verwendung des Java-Agents von Application Insights
