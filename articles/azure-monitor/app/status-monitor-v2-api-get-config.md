...
ms.locfileid: "67807089"
---
# <a name="status-monitor-v2-api-get-applicationinsightsmonitoringconfig-v040-alpha"></a>API für Statusmonitor v2: Get-ApplicationInsightsMonitoringConfig (v0.4.0-alpha)
