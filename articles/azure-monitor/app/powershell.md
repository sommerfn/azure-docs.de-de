...
Sie können den [Tarif](pricing.md) festlegen.
...
* [Erstellen einer Application Insights-Ressource](powershell-script-create-resource.md) : Schnellverfahren ohne Verwendung einer Vorlage.
