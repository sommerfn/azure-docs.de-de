---
title: Java-Web-App-Analyse mit Azure Application Insights (2.5.0-BETA) | Microsoft-Dokumentation
description: 'Überwachung der Anwendungsleistung für Java-Web-Apps mithilfe von Application Insights (2.5.0-BETA). '
...
ms.locfileid: "68298178"
---
# <a name="get-started-with-application-insights-in-a-java-web-project-250-beta"></a>Erste Schritte mit Application Insights in einem Java-Webprojekt (2.5.0-BETA)
...
[Installieren Sie den Java-Agent](java-agent-25-beta.md) zum Erfassen ausgehender HTTP-Aufrufe, für JDBC-Abfragen, Anwendungsprotokollierung und zur besseren Vorgangsbenennung.
