...
5. **[Erstellen eines Wandera-Testbenutzers](#create-wandera-test-user)** , um eine Entsprechung von Britta Simon in Wandera zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Wandera** müssen Sie die heruntergeladene **Metadaten-XML** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von Wandera](https://www.wandera.com/about-wandera/contact/#supportsection) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
