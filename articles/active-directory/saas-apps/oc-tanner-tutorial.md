...
* Sie können in Azure AD steuern, wer auf O.C. Tanner – AppreciateHub.
* Sie können es Ihren Benutzern ermöglichen, dass sie mit ihren Azure AD-Konten automatisch an O.C. Tanner – AppreciateHub angemeldet werden (einmaliges Anmelden; Single Sign-On, SSO).
...
* O.C. Tanner – AppreciateHub-Abonnement
...
4. Geben Sie im Suchfeld den Suchbegriff **O.C. Tanner – AppreciateHub** ein, wählen Sie im Ergebnisbereich **O.C. Tanner – AppreciateHub** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

     ![O.C. Tanner – AppreciateHub in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD bei O.C. Tanner – AppreciateHub mithilfe einer Testbenutzerin namens **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in O.C. Tanner – AppreciateHub muss eine Linkbeziehung eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für O.C. Tanner – AppreciateHub](#configure-oc-tanner---appreciatehub-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines O.C. Tanner – AppreciateHub-Testbenutzers](#create-oc-tanner---appreciatehub-test-user)** – um eine Entsprechung von Britta Simon in O.C. Tanner – AppreciateHub zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **O.C. Tanner – AppreciateHub** die Option **Einmaliges Anmelden**.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus, wenn Sie über eine **Dienstanbieter-Metadatendatei** verfügen:
    ...
    >[!NOTE]
    >Sie können die **Dienstanbieter-Metadatendatei** [hier](https://fed.appreciatehub.com/fed/sp/metadata) herunterladen.
    ...
    c. Nach dem erfolgreichen Upload der Metadatendatei werden die Werte unter **Bezeichner** und **Antwort-URL** im Abschnitt „Grundlegende SAML-Konfiguration“ automatisch eingefügt.
     ...
     ![O.C. Tanner – AppreciateHub: SSO-Informationen zu Domäne und URLs](common/idp-intiated.png)

    > [!Note]
    > Geben Sie die erforderlichen Werte manuell ein, falls die Werte **Bezeichner** und **Antwort-URL** nicht automatisch eingefügt werden. Diesen Wert erhalten Sie vom [Supportteam für O.C. Tanner – AppreciateHub für Kunden](mailto:sso@octanner.com). Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.

5. Klicken Sie auf der Seite **Einmaliges Anmelden (SSO) mit SAML einrichten** im Abschnitt **SAML-Signaturzertifikat** auf **Herunterladen**, um den Ihren Anforderungen entsprechenden **Verbundmetadaten-XML**-Code aus den verfügbaren Optionen herunterzuladen und auf Ihrem Computer zu speichern.

    ![Downloadlink für das Zertifikat](common/metadataxml.png)

6. Kopieren Sie im Abschnitt **O.C. Tanner – AppreciateHub einrichten** die entsprechenden URLs gemäß Ihren Anforderungen.
...
### <a name="configure-oc-tanner---appreciatehub-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für O.C. Tanner – AppreciateHub
...
3. Führen Sie in den Benutzereigenschaften die folgenden Schritte aus.
    ...
    b. Geben Sie in das Feld **Benutzername** den Benutzernamen im Format BrittaSimon@contoso.com ein.
...
In diesem Abschnitt ermöglichen Sie Britta Simon die Verwendung des einmaligen Anmeldens von Azure, indem Sie ihr Zugriff auf O.C. Tanner – AppreciateHub.

1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen**, **Alle Anwendungen** und **O.C. Tanner – AppreciateHub**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **O.C. Tanner – AppreciateHub**.

    ![O.C. Tanner – AppreciateHub-Link in der Anwendungsliste](common/all-applications.png)
