...
* Sie können es Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei TextMagic anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
4. Geben Sie im Suchfeld **TextMagic** ein, wählen Sie im Ergebnisbereich **TextMagic** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
     ...
     ![TextMagic in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit TextMagic mithilfe eines Testbenutzers namens **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in TextMagic eingerichtet werden.
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit TextMagic die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **TextMagic** die Option **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für TextMagic](common/idp-identifier.png)
...
### <a name="configure-textmagic-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für TextMagic

1. Melden Sie sich in einem anderen Webbrowserfenster auf der TextMagic-Unternehmenswebsite als Administrator an.

2. Wählen Sie unter dem Benutzernamen **Kontoeinstellungen** aus.

    ![TextMagic-Konfiguration](./media/textmagic-tutorial/config1.png)

3. Klicken Sie auf die Registerkarte **Single Sign-On (SSO)** (Einmaliges Anmelden (SSO)), und füllen Sie folgende Felder aus:  
...
1. Wählen Sie im Azure-Portal **Unternehmensanwendungen** > **Alle Anwendungen** > **TextMagic** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste den Eintrag **TextMagic** aus.

    ![TextMagic-Link in der Anwendungsliste](common/all-applications.png)
