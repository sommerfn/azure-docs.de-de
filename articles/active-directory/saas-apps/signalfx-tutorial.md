---
title: 'Tutorial: Azure Active Directory-Integration von SignalFx | Microsoft-Dokumentation'
...
* Sie können es Benutzern ermöglichen, dass sie mit ihren Azure AD-Konten automatisch bei SignalFx angemeldet werden (einmaliges Anmelden; Single Sign-On, SSO).
...
* SignalFx-Abonnement, für das einmaliges Anmelden aktiviert ist
...
4. Geben Sie im Suchfeld **SignalFx** ein, wählen Sie im Ergebnisbereich **SignalFx** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
     ...
     ![SignalFx in der Ergebnisliste](common/search-new-app.png)
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in SignalFx eingerichtet werden.
...
1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **SignalFx** die Option **Einmaliges Anmelden**.
...
4. Führen Sie auf der Seite **Einmaliges Anmelden (SSO) mit SAML einrichten** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für SignalFx](common/idp-intiated.png)
...
5. Die SignalFx-Anwendung erwartet die SAML-Assertionen in einem bestimmten Format. Konfigurieren Sie die folgenden Ansprüche für diese Anwendung. Sie können die Werte dieser Attribute im Abschnitt **Benutzerattribute** auf der Anwendungsintegrationsseite verwalten. Klicken Sie auf der Seite **Einmaliges Anmelden (SSO) mit SAML einrichten** auf die Schaltfläche **Bearbeiten**, um das Dialogfeld **Benutzerattribute** zu öffnen.
...
8. Kopieren Sie im Abschnitt **SignalFx einrichten** die entsprechenden URLs gemäß Ihren Anforderungen.
...
### <a name="configure-signalfx-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für SignalFx
...
1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen**, **Alle Anwendungen** und **SignalFx**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste den Eintrag **SignalFx**aus.

    ![SignalFx-Link in der Anwendungsliste](common/all-applications.png)
...
> [!Note]
> Wenn Sie einen Benutzer manuell erstellen müssen, wenden Sie sich an das [SignalFx-Supportteam](mailto:kmazzola@signalfx.com).
