...
* Sie können es Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei Evernote anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
4. Geben Sie im Suchfeld **Evernote** ein, wählen Sie im Ergebnisbereich **Evernote** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
     ...
     ![Evernote in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit Evernote mithilfe eines Testbenutzers namens **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Evernote eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Evernote](#configure-evernote-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Evernote-Testbenutzers](#create-evernote-test-user)** , um eine Entsprechung von Britta Simon in Evernote zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit Evernote die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Evernote** die Option **Einmaliges Anmelden**.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten** Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Evernote](common/idp-identifier.png)
...
### <a name="configure-evernote-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Evernote

1. Melden Sie sich in einem anderen Webbrowserfenster bei der Evernote-Unternehmenswebsite als Administrator an.

2. Wechseln Sie zur **Verwaltungskonsole**.

    ![Admin-Console](./media/evernote-tutorial/tutorial_evernote_adminconsole.png)

3. Wechseln Sie von der **Verwaltungskonsole** zu **Sicherheit**, und wählen Sie **Einmaliges Anmelden**.

    ![SSO-Setting](./media/evernote-tutorial/tutorial_evernote_sso.png)

4. Konfigurieren Sie die folgenden Werte:
...
1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen**, **Alle Anwendungen** und **Evernote** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste den Eintrag **Evernote** aus.

    ![Evernote-Link in der Anwendungsliste](common/all-applications.png)
