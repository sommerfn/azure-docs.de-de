...
* Sie können es Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei Arc Publishing – SSO anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
4. Geben Sie im Suchfeld **Arc Publishing - SSO** ein, wählen Sie im Ergebnisbereich **Arc Publishing - SSO** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
     ...
     ![Arc Publishing - SSO in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit Arc Publishing – SSO mithilfe eines Testbenutzers namens **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Arc Publishing – SSO eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Arc Publishing – SSO](#configure-arc-publishing---sso-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Arc Publishing – SSO-Testbenutzers](#create-arc-publishing---sso-test-user)** , um in Arc Publishing – SSO eine Entsprechung von Britta Simon zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit Arc Publishing – SSO die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Arc Publishing – SSO** die Option **Einmaliges Anmelden**.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Arc Publishing - SSO](common/idp-intiated.png)
...
5. Klicken Sie auf **Zusätzliche URLs festlegen**, und führen Sie den folgenden Schritt aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Arc Publishing - SSO](common/metadata-upload-additional-signon.png)
...
### <a name="configure-arc-publishing---sso-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Arc Publishing – SSO
...
1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen**, **Alle Anwendungen** und **Arc Publishing – SSO**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **Arc Publishing - SSO** aus.

    ![Arc Publishing - SSO-Link in der Anwendungsliste](common/all-applications.png)
