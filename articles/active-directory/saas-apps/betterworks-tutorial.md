...
* Sie können es Benutzern ermöglichen, dass sie mit ihren Azure AD-Konten automatisch bei BetterWorks angemeldet werden (einmaliges Anmelden; Single Sign-On, SSO).
...
* BetterWorks-Abonnement, für das einmaliges Anmelden aktiviert ist
...
4. Geben Sie im Suchfeld **BetterWorks** ein, wählen Sie im Ergebnisbereich die Option **BetterWorks** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![BetterWorks in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD bei BetterWorks mithilfe einer Testbenutzerin namens **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in BetterWorks eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für BetterWorks](#configure-betterworks-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines BetterWorks-Testbenutzers](#create-betterworks-test-user)** , um eine Entsprechung von Britta Simon in BetterWorks zu erhalten, die mit der Darstellung des Benutzers in Azure AD verknüpft ist.
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit BetterWorks die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **BetterWorks** die Option **Einmaliges Anmelden**.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten** Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für BetterWorks](common/idp-intiated.png)

    a. Geben Sie im Textfeld **Bezeichner** eine URL im folgenden Format ein: `https://app.betterworks.com/saml2/metadata/`

    b. Geben Sie im Textfeld **Antwort-URL** eine URL im folgenden Format ein: `https://app.betterworks.com/saml2/acs/`

5. Klicken Sie auf **Zusätzliche URLs festlegen**, und führen Sie den folgenden Schritt aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für BetterWorks](common/metadata-upload-additional-signon.png)

    Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://app.betterworks.com`

    > [!NOTE]
    > Hierbei handelt es sich um Beispielwerte. Sie müssen diese Werte mit dem tatsächlichen Bezeichner, der Antwort-URL und der Anmelde-URL aktualisieren. Wenden Sie sich an das [Kundensupportteam von BetterWorks](mailto:support@betterworks.com), um diese Werte zu erhalten. Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.

6. Ihre BetterWorks-Anwendung erwartet die SAML-Assertionen in einem bestimmten Format. Daher müssen Sie Ihrer Konfiguration der SAML-Tokenattribute benutzerdefinierte Attributzuordnungen hinzufügen. Der folgende Screenshot zeigt die Liste der Standardattribute. Klicken Sie auf das Symbol **Bearbeiten**, um das Dialogfeld **Benutzerattribute** zu öffnen.
...
9. Kopieren Sie im Abschnitt **BetterWorks einrichten** die entsprechenden URLs gemäß Ihren Anforderungen.
...
### <a name="configure-betterworks-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für BetterWorks
...
1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen**, **Alle Anwendungen** und **BetterWorks**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **BetterWorks**aus.

    ![BetterWorks-Link in der Anwendungsliste](common/all-applications.png)
