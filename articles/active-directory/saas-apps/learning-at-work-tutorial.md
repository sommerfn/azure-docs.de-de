...
* Sie können Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei Learning at Work anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
* Learning at Work-Abonnement, für das einmaliges Anmelden aktiviert ist
...
4. Geben Sie im Suchfeld **Learning at Work** ein, wählen Sie im Ergebnisbereich die Option **Learning at Work**, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

     ![Learning at Work in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

Dieser Abschnitt veranschaulicht anhand einer Testbenutzerin namens **Britta Simon**, wie das einmalige Anmelden von Azure AD in Learning at Work konfiguriert und getestet wird.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Learning at Work eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Learning at Work](#configure-learning-at-work-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Learning at Work-Testbenutzers](#create-learning-at-work-test-user)** , um eine Entsprechung von Britta Simon in Learning at Work zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Learning at Work** die Option **Einmaliges Anmelden**.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Learning at Work](common/sp-identifier.png)
...
### <a name="configure-learning-at-work-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Learning at Work
...
1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen**, **Alle Anwendungen** und **Learning at Work**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste die Option **Learning at Work**aus.

    ![Learning at Work-Link in der Anwendungsliste](common/all-applications.png)
...
In diesem Abschnitt erstellen Sie in Learning at Work einen Benutzer namens Britta Simon. Arbeiten Sie mit dem [Supportteam von Learning at Work](https://www.learninga-z.com/site/contact/support) zusammen, um die Benutzer der Learning at Work-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.
