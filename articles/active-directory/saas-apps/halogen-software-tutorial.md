...
* Sie können in Azure AD steuern, wer Zugriff auf Halogen Software hat.
* Sie können es Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei Halogen Software anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
* Halogen Software unterstützt **SP-initiiertes** einmaliges Anmelden.
...
4. Geben Sie im Suchfeld **Halogen Software** ein, wählen Sie im Ergebnisbereich **Halogen Software** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

     ![Halogen Software in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

Dieser Abschnitt veranschaulicht anhand eines Testbenutzers namens **Britta Simon**, wie das einmalige Anmelden von Azure AD mit Halogen Software konfiguriert und getestet wird.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Halogen Software eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Halogen Software](#configure-halogen-software-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Halogen Software-Testbenutzers](#create-halogen-software-test-user)** , um ein Pendant von Britta Simon in Halogen Software zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit Halogen Software die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Halogen Software** die Option **Einmaliges Anmelden**.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Halogen Software](common/sp-identifier.png)
    ...
    > [!NOTE]
    > Hierbei handelt es sich um Beispielwerte. Ersetzen Sie diese Werte durch die tatsächliche Anmelde-URL und den tatsächlichen Bezeichner. Wenden Sie sich an das [Clientsupportteam von Halogen Software](https://support.halogensoftware.com/), um diese Werte zu erhalten. Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
6. Kopieren Sie im Abschnitt **Halogen Software einrichten** die entsprechenden URLs gemäß Ihren Anforderungen.
...
### <a name="configure-halogen-software-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Halogen Software
...
2. Klicken Sie auf die Registerkarte **Options** .
    ...
    ![Was ist Azure AD Connect?](./media/halogen-software-tutorial/tutorial_halogen_12.png)

3. Klicken Sie im linken Navigationsbereich auf **SAML-Konfiguration**.
  
    ![Was ist Azure AD Connect?](./media/halogen-software-tutorial/tutorial_halogen_13.png)

4. Führen Sie auf der Seite **SAML-Konfiguration** die folgenden Schritte aus:

    ![Was ist Azure AD Connect?](./media/halogen-software-tutorial/tutorial_halogen_14.png)
...
1. Wählen Sie im Azure-Portal die Option **Unternehmensanwendungen** aus, und wählen Sie dann **Alle Anwendungen** und **Halogen Software** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **Halogen Software**aus.

    ![Halogen Software-Link in der Anwendungsliste](common/all-applications.png)
...
### <a name="create-halogen-software-test-user"></a>Erstellen eines Testbenutzers für Halogen Software
...
2. Klicken Sie auf die Registerkarte **Benutzercenter** und dann auf **Benutzer erstellen**.
    ...
    ![Was ist Azure AD Connect?](./media/halogen-software-tutorial/tutorial_halogen_300.png)  

3. Führen Sie auf der Dialogfeldseite **Neuer Benutzer** die folgenden Schritte aus:

    ![Was ist Azure AD Connect?](./media/halogen-software-tutorial/tutorial_halogen_301.png)
...
Wenn Sie im Zugriffsbereich auf die Kachel „Halogen Software“ klicken, sollten Sie automatisch bei der Halogen Software-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
