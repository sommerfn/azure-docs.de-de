...
* Collaborative Innovation-Abonnement, für das einmaliges Anmelden aktiviert ist
...
4. Geben Sie im Suchfeld **Collaborative Innovation** ein, wählen Sie im Ergebnisbereich **Collaborative Innovation** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

     ![Collaborative Innovation in der Ergebnisliste](common/search-new-app.png)
...
Damit das einmalige Anmelden funktioniert, muss zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Collaborative Innovation eine Linkbeziehung eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Collaborative Innovation](#configure-collaborative-innovation-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Collaborative Innovation-Testbenutzers](#create-collaborative-innovation-test-user)** , um ein Pendant von Britta Simon in Collaborative Innovation zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Collaborative Innovation** die Option **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Collaborative Innovation](common/sp-identifier.png)
...
5. Die Collaborative Innovation-Anwendung erwartet die SAML-Assertionen in einem bestimmten Format. Konfigurieren Sie die folgenden Ansprüche für diese Anwendung. Sie können die Werte dieser Attribute im Abschnitt **Benutzerattribute** auf der Anwendungsintegrationsseite verwalten. Klicken Sie auf der Seite **Einmaliges Anmelden (SSO) mit SAML einrichten** auf die Schaltfläche **Bearbeiten**, um das Dialogfeld **Benutzerattribute** zu öffnen.
...
6. Kopieren Sie im Abschnitt **Collaborative Innovation einrichten** die entsprechenden URLs gemäß Ihren Anforderungen.
...
### <a name="configure-collaborative-innovation-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Collaborative Innovation
...
1. Wählen Sie im Azure-Portal die Option **Unternehmensanwendungen** aus, und wählen Sie dann **Alle Anwendungen** und **Collaborative Innovation** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Liste der Anwendungen **Collaborative Innovation**.

    ![Der Link „Collaborative Innovation“ in der Anwendungsliste](common/all-applications.png)
