...
2. Klicken Sie im Azure-Portal auf **Marketplace**.
    ...
    ![Erstellen](./media/enable/01.png "Erstellen")

3. Klicken Sie in der Anwendungsliste auf **Identität**.
   
    ![Erstellen](./media/enable/05.png "Erstellen")

4. Klicken Sie auf **Azure AD Identity Protection**.
   
    ![Erstellen](./media/enable/06.png "Erstellen")

5. Klicken Sie auf dem Blatt **Azure AD Identity Protection** auf **Erstellen**.
   
    ![Erstellen](./media/enable/04.png "Erstellen")
