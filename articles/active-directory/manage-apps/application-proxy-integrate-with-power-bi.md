...
Weitere Informationen finden Sie unter [Ändern einer Reporting Services-Konfigurationsdatei (RSreportserver.config)](https://msdn.microsoft.com/library/bb630448.aspx) sowie unter [Konfigurieren der Windows-Authentifizierung auf dem Berichtsserver](https://msdn.microsoft.com/library/cc281253.aspx).
...
4. Legen Sie die Delegierungseinstellungen auf **Computer bei Delegierungen angegebener Dienste vertrauen** fest. Wählen Sie anschließend **Beliebiges Authentifizierungsprotokoll verwenden** aus.
...
7. Klicken Sie auf **OK**. Klicken Sie erneut auf **OK**, um die Änderungen zu speichern.
...
2. Nachdem die App veröffentlicht wurde, konfigurieren Sie die Einstellungen für einmaliges Anmelden anhand der folgenden Schritte:
   ...
   d. Wählen Sie die **delegierte Identität für die Anmeldung** aus, die der Connector im Auftrag Ihrer Benutzer verwenden soll. Weitere Informationen finden Sie unter  [Working with different on-premises and cloud identities](application-proxy-configure-single-sign-on-with-kcd.md#working-with-different-on-premises-and-cloud-identities) (Verwenden verschiedener lokaler und cloudbasierter Identitäten).
...
> [!NOTE]
> Diese Funktion ist erst ab dem 31.7.2019 verfügbar.
