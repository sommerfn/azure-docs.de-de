...
Wenn Sie einen vertraulichen Client mit geheimen Clientschlüsseln erstellen, ähnelt die Konfigurationsdatei diesem Auszug aus dem Beispiel [confidential_client_secret_sample.py#L4-L15](https://github.com/AzureAD/microsoft-authentication-library-for-python/blob/0.6.1/sample/confidential_client_secret_sample.py#L4-L15) in GitHub.
...
Wenn Sie einen vertraulichen Client mit Zertifikaten erstellen, ähnelt die Konfigurationsdatei dem Auszug aus dem Beispiel [confidential_client_certificate_sample.py#L4-L15](https://github.com/AzureAD/microsoft-authentication-library-for-python/blob/4b34fd660e5574eb876cfba63a1b927ae375efd6/sample/confidential_client_certificate_sample.py#L4-L15) in GitHub.
...
Nachstehend finden Sie die Klasse, die in den msal4j-Entwicklungsbeispielen zum Konfigurieren der Beispiele verwendet wird: [TestData](https://github.com/AzureAD/microsoft-authentication-library-for-java/blob/dev/src/samples/public-client/TestData.java).
...
Stellen Sie entweder eine vertrauliche Client-ID (CONFIDENTIAL_CLIENT_ID) oder einen vertraulichen geheimen Clientschlüssel (CONFIDENTIAL_CLIENT_SECRET) bereit. Beide Einstellungen sind exklusiv.
...
Einzelheiten finden Sie in der Referenzdokumentation für MSAL.Python für die [Vertrauliche Clientanwendung (ConfidentialClientApplication)](https://msal-python.readthedocs.io/en/latest/#msal.ClientApplication.__init__).

# <a name="javatabjava"></a>[Java](#tab/java)

msal4j befindet sich in der öffentlichen Vorschau. Signierte Assertionen werden noch nicht unterstützt.
