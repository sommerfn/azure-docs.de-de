...
> [!NOTE]
> Möchten Sie lieber das Visual Studio-Projekt dieses Beispiels herunterladen, anstatt die Erstellung durchzuführen? [Laden Sie ein Projekt herunter](https://github.com/Azure-Samples/active-directory-dotnet-native-uwp-v2/archive/msal3x.zip), und fahren Sie mit dem Schritt [Anwendungsregistrierung](#register-your-application "aSchritt Anwendungsregistrierung“) fort, um das Codebeispiel vor der Ausführung zu konfigurieren.
