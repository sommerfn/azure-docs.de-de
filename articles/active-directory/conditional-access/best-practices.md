...
Ja, Sie können Exchange ActiveSync mit einigen [Einschränkungen](block-legacy-authentication.md) in einer Richtlinie für bedingten Zugriff verwenden. 
