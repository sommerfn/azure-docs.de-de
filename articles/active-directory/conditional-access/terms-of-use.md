...
description: Hier finden Sie eine Einführung in die Verwendung der Azure Active Directory-Nutzungsbedingungen zum Anzeigen von Informationen für Mitarbeiter oder Gäste, bevor diese Zugriff erhalten.
...
1. Navigieren Sie unter [https://aka.ms/catou](https://aka.ms/catou) zu **Nutzungsbedingungen**.
    ...
    ![Blatt für Nutzungsbedingungen](./media/terms-of-use/tou-blade.png)

1. Klicken Sie auf **Neue Bedingungen**.

    ![Hinzufügen von Nutzungsbedingungen](./media/terms-of-use/new-tou.png)
...
1. Wenn die Zustimmungen zu Nutzungsbedingungen nach einem Zeitplan ablaufen sollen, legen Sie **Ablauf für Einwilligungen** auf **Ein** fest. Wenn diese Option aktiviert ist, werden zwei zusätzliche Zeitplaneinstellungen angezeigt.
    ...
    ![Ablauf für Einwilligungen](./media/terms-of-use/expire-consents.png)
...
1. Verwenden Sie unter **Bedingter Zugriff** die Liste **Mit Richtlinienvorlagen für bedingten Zugriff erzwingen**, um die Vorlage zum Erzwingen der Nutzungsbedingungen auszuwählen.
    ...
    ![Vorlagen für bedingten Zugriff](./media/terms-of-use/conditional-access-templates.png)
    ...
    >Die Richtliniensteuerungen für den bedingten Zugriff (einschließlich Nutzungsbedingungen) unterstützen die Erzwingung für Dienstkonten nicht. Es wird empfohlen, alle Dienstkonten von der Richtlinie für den bedingten Zugriff auszuschließen.
     ...
     Benutzerdefinierte Richtlinien für den bedingten Zugriff ermöglichen präzise Nutzungsbedingungen bis auf die Ebene einer spezifischen Cloudanwendung oder Benutzergruppe. Weitere Informationen finden Sie unter [Schnellstart: Fordern der Annahme von Nutzungsbedingungen vor dem Zugreifen auf Cloud-Apps](require-tou.md).
...
1. Klicken Sie auf **Create**.
    ...
    ![Benutzerdefinierte Richtlinie](./media/terms-of-use/custom-policy.png)

    Ihre neuen Nutzungsbedingungen werden angezeigt.

    ![Hinzufügen von Nutzungsbedingungen](./media/terms-of-use/create-tou.png)
...
1. Melden Sie sich unter [https://aka.ms/catou](https://aka.ms/catou) bei Azure an, und navigieren Sie zu **Nutzungsbedingungen**.
    ...
    ![Blatt für Nutzungsbedingungen](./media/terms-of-use/view-tou.png)
...
1. Um den Verlauf für einen einzelnen Benutzer anzuzeigen, klicken Sie auf die Auslassungspunkte ( **...** ) und dann auf **Verlauf anzeigen**.
    ...
    ![Bereich „Verlauf anzeigen“](./media/terms-of-use/view-history-pane.png)
...
1. Klicken Sie auf **Überwachungsprotokolle anzeigen**.
    ...
    ![Blatt für Nutzungsbedingungen](./media/terms-of-use/audit-tou.png)
...
1. Auf dem Bildschirm mit den Azure AD-Überwachungsprotokollen können Sie die Informationen mithilfe der bereitgestellten Listen nach bestimmten Überwachungsprotokollinformationen filtern.
    ...
    ![Überwachungsprotokolle](./media/terms-of-use/audit-logs-tou.png)

    Wenn Sie auf ein Protokoll klicken, wird ein Bereich mit weiteren Aktivitätsdetails angezeigt.

    ![Aktivitätsdetails](./media/terms-of-use/audit-log-activity-details.png)
...
![Anmeldung für Webbenutzer](./media/terms-of-use/user-tou.png)
...
![Anzeigen der Nutzungsbedingungen mit Zoomschaltflächen](./media/terms-of-use/zoom-buttons.png)

Der folgende Bildschirm veranschaulicht die Darstellung der Nutzungsbedingungen auf mobilen Geräten:

![Anmeldung für Benutzer mobiler Geräte](./media/terms-of-use/mobile-tou.png)
...
1. Klicken Sie in Ihrem Profil auf **Nutzungsbedingungen lesen**.
    ...
    ![Profil – Nutzungsbedingungen lesen](./media/terms-of-use/tou13a.png)
...
1. Ändern Sie im Bereich „Bedingungen bearbeiten“ den Namen und Anzeigenamen, oder fordern Sie von Benutzern, Werte zu erweitern.
    ...
    ![Nutzungsbedingungen bearbeiten](./media/terms-of-use/edit-tou.png)
...
1. Klicken Sie im Detailbereich auf die Registerkarte **Sprachen**.
    ...
    ![Hinzufügen von Nutzungsbedingungen](./media/terms-of-use/languages-tou.png)
...
1. Laden Sie in den Bereich „Sprache der Nutzungsbedingungen hinzufügen“ Ihre lokalisierte PDF-Datei hoch, und wählen Sie die Sprache aus.
    ...
    ![Hinzufügen von Nutzungsbedingungen](./media/terms-of-use/language-add-tou.png)
...
![Windows 10 und Microsoft Edge – Aufforderung zum Einbinden des Geräts](./media/terms-of-use/per-device-win10-edge.png)
...
![Nicht unterstützte Browser](./media/terms-of-use/per-device-browser-unsupported.png)
...
1. Klicken Sie in der Bestätigungsmeldung auf **Ja**.
    ...
    ![Löschen der Nutzungsbedingungen](./media/terms-of-use/delete-tou.png)
...
![Alle Gastbenutzer](./media/terms-of-use/b2b-guests.png)
...
![Cloud-App Azure Information Protection](./media/terms-of-use/cloud-app-info-protection.png)
...
![Cloud-App Microsoft Intune](./media/terms-of-use/cloud-app-intune.png)
