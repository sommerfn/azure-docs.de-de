...
Die Indizierung wird angehalten, wenn die Fehleranzahl ['maxFailedItems'](cognitive-search-concept-troubleshooting.md#tip-3-see-what-works-even-if-there-are-some-failures) überschreitet. Die folgenden Abschnitte helfen Ihnen, Fehler zu beheben, damit die Indizierung fortgesetzt werden kann.
