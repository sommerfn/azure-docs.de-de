...
description: Hier erfahren Sie, wie Sie mit Node.js und den Azure Search-REST-APIs einen Index erstellen, Daten laden und Abfragen ausführen.
author: jj09
manager: jlembicz
services: search
ms.service: search
