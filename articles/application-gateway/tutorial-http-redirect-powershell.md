...
![Sicherheitswarnung](./media/tutorial-http-redirect-powershell/application-gateway-secure.png)
...
![Testen der Basis-URL im Anwendungsgateway](./media/tutorial-http-redirect-powershell/application-gateway-iistest.png)
