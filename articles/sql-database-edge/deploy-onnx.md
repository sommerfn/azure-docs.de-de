...
In diesem Schnellstart erfahren Sie, wie Sie ein Modell trainieren, es in ONNX konvertieren, anschließend in Azure SQL Database Edge-Vorschau bereitstellen und dann mithilfe des hochgeladenen ONXX-Modells natives PREDICT für Daten ausführen.
