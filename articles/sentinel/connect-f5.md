...
Sie müssen einen Agent auf einem dedizierten Linux-Computer (VM oder lokal) bereitstellen, um die Kommunikation zwischen F5 und Azure Sentinel zu ermöglichen. Die folgende Abbildung beschreibt die Einrichtung für eine Linux-VM in Azure.
...
1. Klicken Sie im Azure Sentinel-Portal auf **Data connectors** (Datenconnectors), und wählen Sie **F5** und dann **Open connector page** (Connectorseite öffnen) aus. 
...
## <a name="step-2-configure-your-f5-to-send-cef-messages"></a>SCHRITT 2: Konfigurieren von F5 zum Senden von CEF-Nachrichten
