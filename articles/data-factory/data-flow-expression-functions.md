...
Füllt die Zeichenfolge nach links mit der angegebenen Auffüllung bis zu einer bestimmten Länge auf. Wenn die Zeichenfolge gleich der Länge oder größer als diese ist, findet keine Operation statt: * ``lpad('great', 10, '-') -> '___--great'``
* ``lpad('great', 4, '-') -> 'great'``
* ``lpad('great', 8, '<>') -> '<><great'``
___
### <code>ltrim</code>
...
Füllt die Zeichenfolge nach rechts mit der angegebenen Auffüllung bis zu einer bestimmten Länge auf. Wenn die Zeichenfolge gleich oder größer der Länge ist, findet keine Operation statt: * ``rpad('great', 10, '-') -> 'great___--'``
* ``rpad('great', 4, '-') -> 'great'``
* ``rpad('great', 8, '<>') -> 'great<><'``
___
