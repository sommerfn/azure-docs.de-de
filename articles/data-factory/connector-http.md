...
Für das Kopieren von Daten aus HTTP in den Formaten **ORC/Avro/JSON** werden folgende Eigenschaften unterstützt:
...
Für das Kopieren von Daten aus HTTP in den Formaten **ORC/Avro/JSON** werden folgende Eigenschaften im Abschnitt **source** der Kopieraktivität unterstützt:
