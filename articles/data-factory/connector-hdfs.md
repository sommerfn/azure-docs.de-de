...
Für das Kopieren von Daten aus HDFS im **ORC- oder JSON-Format** werden folgende Eigenschaften unterstützt:
...
Für das Kopieren von Daten aus HDFS im **ORC- oder JSON-Format** werden folgende Eigenschaften im Abschnitt **source** der Kopieraktivität unterstützt:
