...
Wenn Sie weitere Details zu den Unterschieden benötigen, finden Sie diese auf den separaten Seiten für [Einzeldatenbank und Pools für elastische Datenbanken](sql-database-transact-sql-information.md) sowie [Verwaltete Instanz](sql-database-managed-instance-transact-sql-information.md).
...
| Ressourcenpools | Ja, als [Pools für elastische Datenbanken](sql-database-elastic-pool.md) | Integriert: Eine einzelne verwaltete Instanz kann mehrere Datenbanken aufweisen, die denselben Ressourcenpool gemeinsam nutzen. |
...
| Automatische Skalierung | Ja, im [serverlosen Modell](sql-database-serverless.md) | Nein, Sie müssen reservierte Compute- und Speicheroptionen auswählen. |
...
| **SQL-Tool** | **Einzeldatenbanken und Pools für elastische Datenbanken** | **Verwaltete Instanzen** |
| --- | --- | --- |
