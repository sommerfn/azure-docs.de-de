...
## <a id="sensitive-entities"></a>Identifizieren von vertraulichen Entitäten in der Lösung und Implementieren der Änderungsüberwachung
...
## <a id="auditing"></a>Sicherstellen, dass Überwachung und Protokollierung für die Anwendung erzwungen werden
...
## <a id="log-rotation"></a>Sicherstellen, dass die Protokollrotation und -trennung vorhanden sind
...
## <a id="log-sensitive-data"></a>Sicherstellen, dass die Anwendung keine sensiblen Benutzerdaten protokolliert
...
## <a id="log-restricted-access"></a>Sicherstellen, dass für die Überwachungs- und Protokolldateien der Zugriff eingeschränkt ist
...
## <a id="user-management"></a>Sicherstellen, dass Ereignisse der Benutzerverwaltung protokolliert werden
...
## <a id="inbuilt-defenses"></a>Sicherstellen, dass das System über integrierte Schutzmaßnahmen gegen missbräuchliche Nutzung verfügt
...
## <a id="diagnostics-logging"></a>Aktivieren der Diagnoseprotokollierung für Web-Apps in Azure App Service
...
## <a id="identify-sensitive-entities"></a>Sicherstellen, dass die Anmeldungsüberwachung in SQL Server aktiviert ist
...
## <a id="sufficient-logging"></a>Implementieren einer ausreichenden Protokollierung
...
## <a id="audit-failure-handling"></a>Implementieren einer ausreichenden Behandlung von Überwachungsfehlern
...
## <a id="logging-field-gateway"></a>Sicherstellen, dass geeignete Überwachung und Protokollierung auf dem Bereichsgateway erzwungen werden
...
## <a id="logging-cloud-gateway"></a>Sicherstellen, dass geeignete Überwachung und Protokollierung auf dem Cloudgateway erzwungen werden
