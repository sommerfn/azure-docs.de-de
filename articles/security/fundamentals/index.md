---
title: Dokumentation mit grundlegenden Azure-Sicherheitsinformationen
description: Hier finden Sie Informationen zur Sicherheit von Azure.
services: security
author: arob98
manager: angrobe
layout: LandingPage
...
ms.locfileid: "70148896"
---
# <a name="azure-security-fundamentals-documentation"></a>Dokumentation mit grundlegenden Azure-Sicherheitsinformationen

Hier finden Sie Informationen zur Sicherheit von Azure.
        ...
        <a href="/azure/security/fundamentals/infrastructure">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Wie sichert Microsoft die Azure-Infrastruktur?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/develop">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Entwickeln und Bereitstellen von sicheren Anwendungen</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/develop/secure-dev-overview">Sichere Entwicklung: bewährte Methoden</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/abstract-network-security">Azure-Netzwerksicherheit</a>
                            </li>
                            <li style="list-style: none;">
