...
- [Azure-Protokollintegration](azure-log-integration-overview.md)
...
* Wenn Sie Telemetriedaten bereitstellen möchten, lassen Sie das Kontrollkästchen aktiviert. Wenn Sie keine Nutzungsinformationen an Microsoft senden möchten, deaktivieren Sie das Kontrollkästchen.
   ...
   Weitere Informationen zur Azure-Protokollintegration und zur Installation finden Sie unter [Azure-Protokollintegration mit Azure-Diagnoseprotokollierung und Windows-Ereignisweiterleitung](azure-log-integration-get-started.md).
...
1. Importieren Sie die AzLog-Cmdlets, indem Sie das Script „LoadAzLogModule.ps1“ ausführen. Geben Sie den Befehl `.\LoadAzLogModule.ps1` ein. (Beachten Sie das „.\"“ in diesem Befehl.) Die Ausgabe sollte folgendermaßen aussehen:</br>
   ...
   ![Liste der geladenen Module](./media/azure-log-integration-keyvault-eventhub/loaded-modules.png)
...
1. Erstellen Sie eine Ressourcengruppe:
   ...
   ![Ausgabe nach der Erstellung einer Ressourcengruppe](./media/azure-log-integration-keyvault-eventhub/create-rg.png)
...
>
>![Fehler beim Profil des Ressourcen-Manager](./media/azure-log-integration-keyvault-eventhub/rm-profile-error.png)
...
1. Legen Sie ein Geheimnis fest und lassen Sie es lesen, um weitere Protokolleinträge zu erzeugen:
   ...
   ![Zurückgegebenes Geheimnis](./media/azure-log-integration-keyvault-eventhub/keyvaultsecret.png)
...
- [Azure Log Integration FAQ (Azure-Protokollintegration (FAQ))](azure-log-integration-faq.md)
- [Get started with Azure Log Integration (Erste Schritte mit der Azure-Protokollintegration)](azure-log-integration-get-started.md)
- [Integrate logs from Azure resources into your SIEM systems (Integrieren von Protokollen aus Azure-Ressourcen in Ihre SIEM-Systeme)](azure-log-integration-overview.md)
