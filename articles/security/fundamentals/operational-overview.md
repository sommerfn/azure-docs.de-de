...
- [Mehrstufige Authentifizierung](/azure/multi-factor-authentication/multi-factor-authentication)
...
Security Center verwendet die [rollenbasierte Zugriffssteuerung](/azure/role-based-access-control/role-assignments-portal) (Role-Based Access Control, RBAC). RBAC stellt [integrierte Rollen](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles) bereit, die Benutzern, Gruppen und Diensten in Azure zugewiesen werden können.
