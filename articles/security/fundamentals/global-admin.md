...
Aktivieren Sie darüber hinaus [Azure Multi-Factor Authentication (MFA)](../../active-directory/authentication/multi-factor-authentication.md) für Ihre Administratoren, um eine zweite Sicherheitsebene für Benutzeranmeldungen und Transaktionen hinzuzufügen. Azure MFA hilft der IT, die Wahrscheinlichkeit zu verringern, dass kompromittierte Anmeldeinformationen Zugriff auf die Daten einer Organisation erhalten.
...
Erfahren Sie, wie [MFA](../../active-directory/authentication/howto-mfa-mfasettings.md) arbeitet, bevor Sie fortfahren.
