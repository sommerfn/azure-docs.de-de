...
## <a id="cipher-length"></a>Ausschließliches Verwenden von genehmigten symmetrischen Blockchiffren und Schlüssellängen
...
## <a id="vector-ciphers"></a>Verwenden von genehmigten Blockchiffremodi und Initialisierungsvektoren für symmetrische Chiffren
...
## <a id="padding"></a>Verwenden von genehmigten asymmetrischen Algorithmen, Schlüssellängen und Auffüllungen
...
## <a id="numgen"></a>Verwenden von genehmigten Zufallszahlengeneratoren
...
## <a id="mac-hash"></a>Verwenden von genehmigten MAC-, HMAC- und schlüsselgebundenen Hashalgorithmen
...
## <a id="ssis-signed"></a>SSIS-Pakete sollten verschlüsselt und digital signiert werden
...
## <a id="securables-db"></a>Hinzufügen einer digitalen Signatur zu kritischen sicherungsfähigen Elementen von Datenbanken
...
## <a id="keys-engine"></a>Verwenden des Features AlwaysEncrypted, wenn Verschlüsselungsschlüssel für das Datenbankmodul nicht offengelegt werden sollen
...
## <a id="keys-iot"></a>Sicheres Speichern von kryptografischen Schlüsseln auf dem IoT-Gerät
...
## <a id="random-hub"></a>Generieren eines zufälligen symmetrischen Schlüssels mit einer ausreichenden Länge für die Authentifizierung gegenüber IoT Hub
...
## <a id="pin-remote"></a>Sicherstellen der Verwendung einer Richtlinie für die Geräteverwaltung, die für die Nutzung eine PIN erforderlich macht und das Remotelöschen ermöglicht
...
## <a id="bitlocker"></a>Sicherstellen der Verwendung einer Richtlinie für die Geräteverwaltung, die PIN/Kennwort/automatische Sperre erforderlich macht und alle Daten verschlüsselt (z.B. BitLocker)
...
## <a id="rolled-server"></a>Sicherstellen, dass für Signaturschlüssel bei Verwendung von Identity Server ein Rollover durchgeführt wird
...
## <a id="client-server"></a>Stellen Sie sicher, dass in Identity Server eine in kryptografischer Hinsicht sichere Client-ID und ein sicherer geheimer Clientschlüssel verwendet werden.
