---
title: 'Schnellstart: Konvertieren eines Textskripts mit Go: Textübersetzungs-API'
...
ms.locfileid: "66515206"
---
# <a name="quickstart-use-the-translator-text-api-to-transliterate-text-using-go"></a>Schnellstart: Verwenden der Textübersetzungs-API für die Transliteration von Text mit Go
