...
In diesem Schnellstart erfahren Sie, wie Sie Text mithilfe von .NET Core (C#), C# 7.1 und höher und der Textübersetzungs-REST-API zwischen Skripts transliterieren (konvertieren). Im angegebenen Beispiel wird Japanisch in das lateinische Alphabet transliteriert.
