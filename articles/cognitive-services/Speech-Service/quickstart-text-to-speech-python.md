...
ms.locfileid: "71803673"
---
# <a name="quickstart-synthesize-speech-with-the-speech-sdk-for-python"></a>Schnellstart: Sprachsynthese mit dem Speech SDK für Python

Schnellstarts sind auch für [Spracherkennung](quickstart-python.md) verfügbar.

In diesem Artikel wird erläutert, wie die Speech-Dienste über das Speech SDK für Python verwendet werden. Er veranschaulicht, wie Sprache aus Text synthetisiert und über die Standardaudioausgabe wiedergegeben wird.
...
1. Klicken Sie zum Ausführen des Beispielcodes mit der rechten Maustaste an einer beliebigen Stelle im Editor. Wählen Sie **Run Python File in Terminal** (Python-Datei im Terminal ausführen) aus.
   ...
   ![Ausführen eines Beispiels](media/sdk/qs-python-vscode-python-run-tts.png)
