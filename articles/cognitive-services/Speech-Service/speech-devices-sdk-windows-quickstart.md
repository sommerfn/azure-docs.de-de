---
title: 'Schnellstart: Ausführen des Speech Devices SDK unter Windows – Speech-Dienste'
...
1. Das standardmäßige Aktivierungswort (Schlüsselwort) ist „Computer“. Auf Wunsch können Sie eines der anderen angebotenen Aktivierungswörter wie „Maschine“ oder „Assistent“ ausprobieren. Die Ressourcendateien für diese alternativen Aktivierungswörter finden Sie im Speech-Geräte-SDK im Ordner „keyword“. Beispielsweise enthält `C:\SDSDK\JRE-Sample-Release\keyword\Computer` die Dateien für das Aktivierungswort „Computer“.
