---
title: 'Schnellstart: Speech SDK für C# (Universelle Windows-Plattform, UWP): Plattformeinrichtung – Speech-Dienst'
titleSuffix: Azure Cognitive Services
description: Verwenden Sie diesen Leitfaden, um Ihre Plattform mit dem Speech Services SDK für C# unter der universellen Windows-Plattform (UWP) einzurichten.
...
ms.locfileid: "73504451"
---
In diesem Leitfaden erfahren Sie, wie Sie das [Speech SDK](~/articles/cognitive-services/speech-service/speech-sdk.md) für C# unter der universellen Windows-Plattform (UWP) installieren.
