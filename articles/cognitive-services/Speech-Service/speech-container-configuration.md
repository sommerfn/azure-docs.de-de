...
|-------------|-------|---|
|{API_KEY} | Der API-Schlüssel der Speech-Ressource. |xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx|
|{ENDPOINT_URI} | Der Endpunktwert, einschließlich der Region.|`https://westus.api.cognitive.microsoft.com/sts/v1.0`|
