...
|`QNAMAKER_HOST`|`host`|`https://your-resource-name.api.cognitive.microsoft.com`: Ändern Sie `your-resource-name` in Ihren eigenen Ressourcennamen.|
||||
