...
Wenn Sie die Antwort nur auf Fragen beschränken möchten, fügen Sie dem Text die Eigenschaft `[rankerType](Learn more about [rankerType](../concepts/best-practices.md#choosing-ranker-type).
)` hinzu, z. B.: 
