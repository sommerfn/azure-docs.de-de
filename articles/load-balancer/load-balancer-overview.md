...
- Im Allgemeinen wird die Weiterleitung von IP-Fragmenten oder die IP-Fragmentierung von UDP- und TCP-Paketen für Lastenausgleichsregeln nicht unterstützt.  [Lastenausgleichsregeln für Hochverfügbarkeitsports](load-balancer-ha-ports-overview.md) stellen eine Ausnahme von dieser allgemeinen Aussage dar. Sie können zum Weiterleiten vorhandener IP-Fragmente verwendet werden.
