...
Sie können Ihren [benutzerdefinierten Richtlinien](active-directory-b2c-overview-custom.md) in Azure Active Directory B2C (Azure AD B2C) die Interaktion mit einer RESTful-API hinzufügen. In diesem Artikel wird veranschaulicht, wie Sie eine Azure AD B2C User Journey erstellen, die mit RESTful-Diensten interagiert.
