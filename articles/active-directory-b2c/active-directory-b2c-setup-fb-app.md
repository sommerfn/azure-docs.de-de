...
3. Wählen Sie **My Apps** (Meine Apps) und dann **Add New App** (Neue App hinzufügen) aus.
...
13. Wählen Sie das Pluszeichen neben **Products** (Produkte) und dann unter **Facebook Login** (Facebook-Anmeldung) die Option **Set up** (Einrichten) aus.
