...
Dieser Artikel stellt eine grundlegende Referenz zum benutzerdefinierten C# RESTful-Endpunkt eines Anbieters dar. Sollten Sie noch nicht mit benutzerdefinierten Azure-Anbietern vertraut sein, sehen Sie sich die [Übersicht über benutzerdefinierte Ressourcenanbieter](./custom-providers-overview.md) an.
