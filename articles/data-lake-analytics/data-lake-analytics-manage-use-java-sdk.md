...
Öffnen Sie die Datei `Main.java`, und ersetzen Sie den vorhandenen Codeblock durch den folgenden Codeausschnitt:
...
* Weitere Informationen zu U-SQL finden Sie unter [Erste Schritte mit der Azure Data Lake Analytics-U-SQL-Sprache](data-lake-analytics-u-sql-get-started.md) und in der [Referenz zur U-SQL-Sprache](https://go.microsoft.com/fwlink/?LinkId=691348).
