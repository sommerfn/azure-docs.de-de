...
Um diese `CustomAddRows`-Funktion als Azure Machine Learning Studio-Modul offenzulegen, muss eine XML-Datei erstellt werden, um anzugeben, wie das Modul **Custom Add Rows** aussehen und sich verhalten soll. 
