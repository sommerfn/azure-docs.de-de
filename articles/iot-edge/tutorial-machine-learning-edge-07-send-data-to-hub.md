...
description: Verwenden Sie Ihren Entwicklungscomputer als simuliertes IoT Edge-Gerät zum Senden von Daten an den IoT-Hub des Geräts, indem Sie ein als transparentes Gateway konfiguriertes Gerät verwenden.
author: kgremban
manager: philmea
ms.author: kgremban
ms.date: 06/13/2019
