...
Weitere Informationen zum Konfigurieren eines Dashboards in Ihrer Azure IoT Central-Anwendung finden Sie unter [Konfigurieren eines Anwendungsdashboards](howto-configure-homepage.md).
