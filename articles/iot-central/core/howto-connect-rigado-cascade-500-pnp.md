...
* Eine Azure IoT Central-Anwendung, die aus einer der Vorschauanwendungsvorlagen erstellt wurde. Weitere Informationen finden Sie unter [Erstellen einer neuen Anwendung](https://docs.microsoft.com/azure/iot-central/core/quick-deploy-iot-central-pnp?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
1. Navigieren Sie im linken Bereich zur Registerkarte ***Gerätevorlagen***, und wählen Sie aus **+ Neue**: ![Neue Gerätevorlage erstellen](./media/howto-connect-rigado-cascade500-pnp/device-template-new.png)
...
1. Wählen Sie die Gerätevorlage „C500“ aus der Liste von vorkonfigurierten Gerätevorlagen aus, wie nachstehend gezeigt wird: ![Auswählen der Gerätevorlage „C500“](./media/howto-connect-rigado-cascade500-pnp/device-template-preconfigured.png)
1. Klicken Sie auf ***Weiter: Anpassen***, um den nächsten Schritt auszuführen. 
...
![Anwendungs-Bereichs-ID](./media/howto-connect-rigado-cascade500-pnp/app-scope-id.png)
3. Klicken Sie jetzt auf **Schlüssel anzeigen**, und notieren Sie sich den **Primärschlüssel**
![Primärschlüssel](./media/howto-connect-rigado-cascade500-pnp/primary-key-sas.png).  
...
![Primärschlüssel](./media/howto-connect-rigado-cascade500-pnp/devices-list-c500.png)  
