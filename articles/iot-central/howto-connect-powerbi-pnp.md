...
ms.locfileid: "69879082"
---
# <a name="visualize-and-analyze-your-azure-iot-central-data-in-a-power-bi-dashboard-preview-features"></a>Visualisieren und Analysieren Ihrer Azure IoT Central-Daten in einem Power BI-Dashboard (Previewfunktionen)

[!INCLUDE [iot-central-pnp-original](../../includes/iot-central-pnp-original-note.md)]

*Dieses Thema gilt für Administratoren.*

![Power BI-Lösungspipeline](media/howto-connect-powerbi-pnp/iot-continuous-data-export.png)
...
- Mit [Kontinuierlichem Datenexport](howto-export-data-blob-storage-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) aus Ihrer IoT Central-App exportierte Daten. Es wird empfohlen, dass Sie Datenströme zu Messungen, Geräten und Gerätevorlagen aktivieren, um das Power BI-Dashboard optimal zu nutzen.
...
![Seite 1 des Power BI-Berichts](media/howto-connect-powerbi-pnp/template-page1-hasdata.PNG)
...
![Seite 2 des Power BI-Berichts](media/howto-connect-powerbi-pnp/template-page2-hasdata.PNG)
...
![Azure-Portal-Ansicht der Ressourcengruppe](media/howto-connect-powerbi-pnp/azure-deployment.PNG)
...
> [Verwalten von Geräten](howto-manage-devices-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)