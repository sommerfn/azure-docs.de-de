...
2. Wählen Sie im Menü auf der linken Seite die Option **Datenexport** aus.
    ...
    ![Erstellen eines neun Event Hubs für kontinuierlichen Datenexport](media/howto-export-data-pnp/export-menu1.png)
...
3. Wählen Sie oben rechts die Schaltfläche **+ Neu** aus. Wählen Sie **Azure Blob Storage** als Ziel für den Export aus. 
    ...
    ![Erstellen eine neuen kontinuierlichen Datenexports](media/howto-export-data-pnp/export-new1.png)
...
4. Wählen Sie im Dropdown-Listenfeld Ihren **Speicherkonto-Namespace** aus. Sie können auch die letzte Option in der Liste auswählen, bei der es sich um **Verbindungszeichenfolge eingeben** handelt. 
    ...
    ![Erstellen eines neun Event Hubs für kontinuierlichen Datenexport](media/howto-export-data-pnp/export-create-blob.png)
...
6. Um den kontinuierlichen Datenexport zu aktivieren, stellen Sie sicher, dass **Datenexport** auf **Ein** festgelegt ist. Wählen Sie **Speichern** aus.
   ...
   ![Konfigurieren des fortlaufenden Datenexports](media/howto-export-data-pnp/export-list-blob.png)
...
> [Visualisieren Ihrer Daten in Power BI](howto-connect-powerbi-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
