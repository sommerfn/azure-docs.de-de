---
title: 'Azure CLI-Skript: Erstellen eines Tabellen-API-Kontos, einer Datenbank und einer Tabelle für Azure Cosmos DB'
description: 'Azure CLI-Skriptbeispiel: Erstellen eines Tabellen-API-Kontos, einer Datenbank und einer Tabelle für Azure Cosmos DB'
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "69616713"
---
# <a name="azure-cosmos-db-create-a-table-api-account-using-azure-cli"></a>Azure Cosmos DB: Erstellen eines Tabellen-API-Kontos mithilfe der Azure CLI

Mit diesem CLI-Beispielskript erstellen Sie ein Tabellen-API-Konto, eine Datenbank und eine Tabelle für Azure Cosmos DB.
...
| [az cosmosdb collection create](/cli/azure/cosmosdb/collection#az-cosmosdb-collection-create) | Erstellt eine Azure Cosmos DB-Tabelle. |
