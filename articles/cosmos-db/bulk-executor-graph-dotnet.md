---
title: Verwenden der Bulk Executor-.NET-Graphbibliothek zum Ausführen von Massenvorgängen in der Gremlin-API von Azure Cosmos DB
...
Weitere Informationen zu den Parametern der Bulk Executor-Bibliothek finden Sie im Thema [Massenimport von Daten in Azure Cosmos DB](https://docs.microsoft.com/azure/cosmos-db/bulk-executor-dot-net#bulk-import-data-to-azure-cosmos-db).
