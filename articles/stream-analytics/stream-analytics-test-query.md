...
In Azure Stream Analytics können Sie Ihre Abfrage testen, ohne den Auftrag zu starten oder zu beenden. Sie können Abfragen mit eingehenden Daten aus Ihrer Eingabesenke testen oder Beispieldaten aus einer lokalen Datei hochladen.
