...
description: Steuerungszuordnung des Blaupausenbeispiels „NIST SP 800-53 R4“ zu Azure Policy und RBAC.
author: DCtheGeek
ms.author: dacoulte
ms.date: 06/24/2019
ms.topic: sample
...
- [Vorschau]: Audit external accounts with read permissions on a subscription
...
- [Vorschau]: Audit CORS resource access restrictions for a Web Application
...
- [Vorschau]: Audit remote debugging state for a Function App
- [Vorschau]: Audit remote debugging state for a Web Application
- [Vorschau]: Audit remote debugging state for an API App
- [Vorschau]: Audit that Linux VMs do not allow remote connections from accounts without passwords
- [Vorschau]: Deploy VM extension to audit that Linux VMs do not allow remote connections from accounts without passwords
...
- [Vorschauversion]: Deploy Log Analytics Agent for Linux VM Scale Sets (VMSS)
- [Vorschau]: Deploy Log Analytics Agent for Linux VMs
- [Vorschauversion]: Deploy Log Analytics Agent for Windows VM Scale Sets (VMSS)
...
- [Vorschau]: Monitor unaudited SQL servers in Azure Security Center
...
- [Vorschau]: Audit that Linux VMs do not have accounts without passwords
- [Vorschau]: Deploy VM extension to audit that Linux VMs do not have accounts without passwords
- [Vorschau]: Audit that Linux VMs have the passwd file permissions set to 0644
- [Vorschau]: Audit that Windows VMs store passwords using reversible encryption
- [Vorschau]: Deploy VM extension to audit that Linux VMs have the passwd file permissions set to 0644
...
- [Vorschau]: Audit that Windows VMs cannot re-use the previous 24 passwords
- [Vorschau]: Audit that Windows VMs have a maximum password age of 70 days
- [Vorschau]: Audit that Windows VMs have a minimum password age of 1 day
- [Vorschau]: Audit that Windows VMs have the password complexity setting enabled
- [Vorschau]: Audit that Windows VMs restrict the minimum password length to 14 characters
- [Vorschau]: Audit that Windows VMs store passwords using reversible encryption
- [Vorschau]: Deploy VM extension to audit that Windows VMs cannot re-use the previous 24 passwords
- [Vorschau]: Deploy VM extension to audit that Windows VMs have a maximum password age of 70 days
- [Vorschau]: Deploy VM extension to audit that Windows VMs have a minimum password age of 1 day
- [Vorschau]: Deploy VM extension to audit that Windows VMs have the password complexity setting enabled
- [Vorschau]: Deploy VM extension to audit that Windows VMs restrict the minimum password length to 14 characters
- [Vorschau]: Deploy VM extension to audit that Windows VMs store passwords using reversible encryption
...
- Überwachen von SQL-Servern ohne Advanced Data Security
- Bereitstellen von Advanced Data Security auf SQL-Servern
- [Vorschau]: Audit OS vulnerabilities on your virtual machine scale sets in Azure Security Center
...
- [Vorschau]: Audit standard tier of DDoS protection is enabled for a virtual network
...
- [Vorschau]: Monitor Internet-facing virtual machines for Network Security Group traffic hardening recommendations
...
- [Vorschau]: Monitor unencrypted SQL databases in Azure Security Center
...
- [Vorschau]: Audit any missing system updates on virtual machine scale sets in Azure Security Center
- [Vorschau]: Audit OS vulnerabilities on your virtual machine scale sets in Azure Security Center
...
- [Vorschau]: Audit the endpoint protection solution on virtual machine scale sets in Azure Security Center
