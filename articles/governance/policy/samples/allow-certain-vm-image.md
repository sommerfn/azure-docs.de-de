---
title: 'Beispiel: Zulassen von nur einem bestimmten VM-Plattformimage'
description: Diese Beispielrichtliniendefinition erfordert, dass virtuelle Computer eine bestimmte Version von UbuntuServer verwenden.
author: DCtheGeek
...
ms.locfileid: "71977845"
---
# <a name="sample---only-allow-a-certain-vm-platform-image"></a>Beispiel: Zulassen von nur einem bestimmten VM-Plattformimage

Erfordert, dass virtuelle Computer eine bestimmte Version von UbuntuServer verwenden.
