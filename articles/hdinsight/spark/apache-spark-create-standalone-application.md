...
![HDInsight: Löschen eines Clusters im Azure-Portal](./media/apache-spark-create-standalone-application/hdinsight-azure-portal-delete-cluster.png "Löschen eines HDInsight-Clusters")
