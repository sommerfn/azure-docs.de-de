...
Im Abschnitt **Bestellungen insgesamt** wird die Anzahl aller erteilten Bestellungen, einschließlich **aktiver** und **stornierter** Bestellungen, während des ausgewählten [Datumsbereichs](#date-range) angezeigt. 
...
![Partner Center, Kundendetails analysieren](./media/analyze-customer-table.png)
...
![Partner Center, Dashboard „Downloads“](./media/analyze-downloads.png)
...
| Cloudinstanzname| Reihenfolge| Die Microsoft Cloud, in der die Bereitstellung eines virtuellen Computers erfolgt ist.||
| Cloudinstanzname: Azure Global| Reihenfolge| Die öffentliche globale Microsoft-Cloud.|| |
| Cloudinstanzname: Azure Government | Reihenfolge| Behördenspezifische Microsoft-Clouds für eines der folgenden Länder: China, Deutschland und USA.| |
...
| Neuer Kunde  | Reihenfolge| Der Wert identifiziert einen neuen Kunden, der zum ersten Mal eines oder mehrere Ihrer Angebote erwirbt (oder nicht). Der Wert ist „Ja“, wenn das Erwerbsdatum im gleichen Kalendermonat liegt. Der Wert ist „Nein“, wenn der Kunde eines Ihrer Angebote vor dem berichteten Kalendermonat gekauft hat. |
| Vorschau-SKU| Reihenfolge| Der Wert gibt an, ob Sie die SKU als „Vorschau“ gekennzeichnet haben. Der Wert ist „Ja“, wenn Sie die SKU entsprechend gekennzeichnet haben und nur von Ihnen autorisierte Azure-Abonnements dieses Image bereitstellen und nutzen können. Der Wert ist „Nein“, wenn die SKU nicht als „Vorschau“ definiert wurde.  |
...
| Marketplace-Lizenztyp| Reihenfolge| Die Abrechnungsmethode für das Marketplace-Angebot.||
| Marketplace-Lizenztyp: Abrechnung über Azure| Reihenfolge| Microsoft ist Ihr Vertreter für dieses Marketplace-Angebot und erstellt Abrechnungen für Kunden in Ihrem Auftrag. (Entweder nutzungsbasierte Bezahlung per Kreditkarte oder Firmenrechnung)||
| Marketplace-Lizenztyp: BYOL (Bring Your Own License) | Reihenfolge| Für die Bereitstellung des virtuellen Computers ist ein vom Kunden bereitgestellter Lizenzschlüssel erforderlich. Microsoft stellt Kunden diese Art von Angebotslistings über den Marketplace nicht in Rechnung.||
| Marketplace-Lizenztyp: Kostenlos| Reihenfolge| Das Angebot ist für alle Benutzer als kostenlos konfiguriert. Microsoft stellt Kunden die Nutzung dieses Angebots nicht in Rechnung.||
| Marketplace-Lizenztyp: Microsoft als Handelspartner  | Reihenfolge| Microsoft ist Ihr Handelspartner für dieses Marketplace-Angebot.|  |
