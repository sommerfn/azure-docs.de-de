...
Gibt einen Endpunkt an, der im Containernetzwerk bereitgestellt werden soll.
...
Deklariert einen Ordner unter PackageRoot, der durch das Name-Attribut benannt wird und statische Datendateien enthält, die zur Laufzeit vom Prozess verarbeitet werden sollen. Service Fabric verwendet alle in den Host- und Supportpaketen angegebenen EXE- und DLLHOST-Dateien, wenn eines der im Dienstmanifest angegebenen Datenpakete aktualisiert wird.
...
Bezeichnungen für Container in der Form Schlüssel=Wert.
...
|type|xs:string|
|use|optional|
|die Standardeinstellung|PlainText|
...
Gibt Richtlinien an, die bestimmen, wie die Service Fabric Runtime für die Replikate bereitgestellt wird.
...
Konfigurationspakete, die im Container bereitgestellt werden sollen.
...
Gibt Netzwerkrichtlinien einschließlich Containernetzwerkrichtlinien an.
