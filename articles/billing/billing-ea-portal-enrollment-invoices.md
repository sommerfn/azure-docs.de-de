...
## <a name="incorrect-overage-invoice"></a>Falsche Überschreitungsrechnung

Wenn Sie der Ansicht sind, dass Ihre Überschreitungsrechnung nicht korrekt ist, finden Sie unter [Grundlegendes zu Ihrer Azure Enterprise-Rechnung](billing-understand-your-bill-ea.md) Informationen zum Abstimmen Ihrer Azure-Nutzungsgebühren. Wenn Sie der Ansicht sind, dass Ihnen die Überschreitung von Microsoft fälschlicherweise in Rechnung gestellt wird, wenden Sie sich an den Support.

## <a name="change-a-po-number-for-an-overage-invoice"></a>Ändern einer Auftragsnummer für eine Überschreitungsrechnung

Das Azure EA-Portal generiert automatisch eine Standardauftragsnummer (Purchase Order, PO), sofern der EA-Administrator vor dem Rechnungsdatum keine Nummer festlegt. Ein EA-Administrator kann die Auftragsnummer im Azure EA-Portal aktualisieren, indem er sich anmeldet und zu **Berichte** navigiert. Ein EA-Administrator kann die Auftragsnummer aktualisieren. Klicken Sie oben rechts, wo die Auftragsnummer angezeigt wird, auf das Stiftsymbol, und aktualisieren Sie die Informationen.

Ein EA-Administrator kann die Auftragsnummer während des laufenden Abrechnungsquartals aktualisieren, bevor eine Rechnung erstellt wird. Er kann die Auftragsnummer auch bis zu sieben Tage nach dem Empfang einer automatisierten E-Mail-Rechnungsbenachrichtigung aktualisieren.

Wenn der EA-Administrator die Auftragsnummer nicht aktualisiert hat und eine neue Auftragsnummer erforderlich ist, besteht die einzige Möglichkeit darin, eine Gutschrift zu erstellen und eine neue Rechnung auszustellen. Wenn ein Kunde die Auftragsnummer aktualisieren muss, wenden Sie sich an Ihren Partner, um Unterstützung zu erhalten.
...
_Getrennt abgerechnete Gebühren_ und _Azure Marketplace-Dienste_ sind Drittanbieterdienste, die über die Azure Marketplace-Plattform bereitgestellt werden. Der Hauptunterschied zwischen den beiden Diensten besteht darin, wie sie der mit dem Drittanbieter geschlossenen Vereinbarung entsprechend abgerechnet werden.

Die Nutzung von Drittanbieterdiensten wird in Ihrer Rechnung unter **Getrennt abgerechnete Gebühren** ausgewiesen. Die Nutzung beansprucht Ihr Azure-Mindestverbrauchsguthaben. Eine Liste von Drittanbietern finden Sie unter [Wiederverkaufsdienste von Drittanbietern im Azure Marketplace nutzen ab sofort den Azure-Mindestverbrauch](https://azure.microsoft.com/updates/azure-marketplace-third-party-reseller-services-now-use-azure-monetary-commitment/).

Die Nutzung, die auf Ihrer Rechnung unter **Azure Marketplace** erscheint, wird getrennt abgerechnet. Sie ist nicht durch den Mindestverbrauch abgedeckt. Alle Gebühren, einschließlich Marketplace, Überschreitung und getrennt abgerechnete Gebühren, werden in einer einzigen Rechnung zusammengefasst.

Sie erhalten eine einzelne Rechnung für Überschreitungsgebühren von Azure-Diensten und für Marketplace-Drittanbieterkäufe.

Wenn Ihr Mindestverbrauch aufgebraucht ist, wird die Nutzung monatlich oder vierteljährlich abgerechnet. Wenn Ihre Registrierung vor Mai 2018 begonnen hat, gilt eine Schwellenwertregel von 150 Prozent des Mindestverbrauchs, und die Überschreitung wird vierteljährlich abgerechnet. Wenn Ihre Registrierung nach Mai 2018 begonnen hat, werden alle Überschreitungen monatlich abgerechnet.
