...
Wenn Sie ein Partner oder Entwickler ohne Azure Enterprise-Registrierung sind und auf die API zugreifen möchten, können Sie die Testregistrierung verwenden. Der Registrierungsname lautet _EnrollmentNumber 100._ Dann können Sie [mit dem Registrierungszugriffsschlüssel Tests durchführen](https://automaticbillingspec.blob.core.windows.net/spec/TestEnrollmentUsageApiKey.txt), um die API aufzurufen und Beispieldaten anzuzeigen.
