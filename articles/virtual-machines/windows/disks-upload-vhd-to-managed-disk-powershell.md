...
description: Erfahren Sie, wie Sie mit Azure PowerShell eine VHD auf einen verwalteten Azure-Datenträger hochladen.
author: roygara
ms.author: rogarana
ms.date: 05/06/2019
ms.topic: article
...
- Eine VHD-Datei, die lokal gespeichert ist.
